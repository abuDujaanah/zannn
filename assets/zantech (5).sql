...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 20, 2024 at 09:41 AM
...
(28, 12, 5, '0000-00-00', '127811.pdf', 'Pending'),
(29, 12, 5, '0000-00-00', '881186.pdf', 'Pending');
...
--
ALTER TABLE `applicants`
  MODIFY `ApplicantID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `specialist`
  MODIFY `SpecialistID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
